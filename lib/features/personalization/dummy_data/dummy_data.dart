...
class DummyData {
  ...
  static final List<CategoriesModel> categories = [
    CategoriesModel(id: '1', image: "", name: 'Sports', isFeatured: true),
    CategoriesModel(id: '5', image: "", name: 'Furniture', isFeatured: true),
    CategoriesModel(id: '2', image: "", name: 'Electronics', isFeatured: true),
    CategoriesModel(id: '3', image: "", name: 'Clothes', isFeatured: true),
    CategoriesModel(id: '4', image: "", name: 'Animals', isFeatured: true),
    CategoriesModel(id: '6', image: "", name: 'Shoes', isFeatured: true),
    CategoriesModel(id: '7', image: "", name: 'Cosmetics', isFeatured: true),
    CategoriesModel(id: '14', image: "", name: 'Jewelery', isFeatured: true),
