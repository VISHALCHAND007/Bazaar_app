...
class TDummyData {
  ...
  static final List<CategoriesModel> categories = [
    CategoriesModel(id: '1', image: TImages.sportIcon, name: 'Sports', isFeatured: true),
    CategoriesModel(id: '5', image: TImages.furnitureIcon, name: 'Furniture', isFeatured: true),
    CategoriesModel(id: '2', image: TImages.electronicsIcon, name: 'Electronics', isFeatured: true),
    CategoriesModel(id: '3', image: TImages.clothIcon, name: 'Clothes', isFeatured: true),
    CategoriesModel(id: '4', image: TImages.animalIcon, name: 'Animals', isFeatured: true),
    CategoriesModel(id: '6', image: TImages.shoeIcon, name: 'Shoes', isFeatured: true),
    CategoriesModel(id: '7', image: TImages.cosmeticsIcon, name: 'Cosmetics', isFeatured: true),
    CategoriesModel(id: '14', image: TImages.jeweleryIcon, name: 'Jewelery', isFeatured: true),

    ///subcategories
    CategoriesModel(id: '8',
        image: TImages.sportIcon,
        name: 'Sport Shoes',
        parentId: '1',
        isFeatured: false),
    CategoriesModel(id: '9',
        image: TImages.sportIcon,
        name: 'Track suits',
        parentId: '1',
        isFeatured: false),
    CategoriesModel(id: '10',
        image: TImages.sportIcon,
        name: 'Sports Equipments',
        parentId: '1',
        isFeatured: false),
    //furniture
    CategoriesModel(id: '11',
        image: TImages.furnitureIcon,
        name: 'Bedroom furniture',
        parentId: '5',
        isFeatured: false),
    CategoriesModel(id: '12',
        image: TImages.furnitureIcon,
        name: 'Kitchen furniture',
        parentId: '5',
        isFeatured: false),
    CategoriesModel(id: '13',
        image: TImages.furnitureIcon,
        name: 'Office furniture',
        parentId: '5',
        isFeatured: false),
    //electronics
    CategoriesModel(id: '14',
        image: TImages.electronicsIcon,
        name: 'Laptop',
        parentId: '2',
        isFeatured: false),
    CategoriesModel(id: '15',
        image: TImages.electronicsIcon,
        name: 'Mobile',
        parentId: '2',
        isFeatured: false),

    CategoriesModel(id: '16',
